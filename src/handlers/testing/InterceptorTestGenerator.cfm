...
<!--- Read test template --->
<cffile action="read" file="#ExpandPath('/contentboxExtesion')#/templates/testing/InterceptorTestContent#scriptPrefix#.txt" 		variable="interceptorTestContent">
<cffile action="read" file="#ExpandPath('/contentboxExtesion')#/templates/testing/InterceptorTestCaseContent#scriptPrefix#.txt" 	variable="interceptorTestCaseContent">
...
<ide>  
	...
	<dialog width="550" height="350" title="ColdBox Interceptor Test Wizard" image="includes/images/ContentBox_43.png"/>  
	<body>
	<![CDATA[
	<html>
		<head>
