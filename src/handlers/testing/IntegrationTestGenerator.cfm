...
<!--- Read in Templates --->
<cffile action="read" file="#expandPath('/contentboxExtesion')#/templates/testing/HandlerTestContent#scriptPrefix#.txt"     variable="handlerTestContent">
<cffile action="read" file="#expandPath('/contentboxExtesion')#/templates/testing/HandlerTestCaseContent#scriptPrefix#.txt" variable="handlerTestCaseContent">
...
<ide>  
	...
	<dialog width="550" height="350" title="ColdBox Integration Test Wizard" image="includes/images/ContentBox_43.png"/>  
	<body><![CDATA[
	<html>
		<head>
