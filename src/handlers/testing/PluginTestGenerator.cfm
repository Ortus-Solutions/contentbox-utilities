...
<!--- Read test template --->
<cffile action="read" file="#expandPath('/contentboxExtesion')#/templates/testing/PluginTestContent#scriptPrefix#.txt" variable="pluginTestContent">
...
<ide>  
	...
	<dialog width="550" height="350" title="ColdBox Plugin Test Wizard" image="includes/images/ContentBox_43.png"/>  
	<body>
	<![CDATA[
	<html>
		<head>
