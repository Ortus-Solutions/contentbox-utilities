...
<!--- Read test template --->
<cffile action="read" file="#expandPath('/contentboxExtesion')#/templates/testing/ModelTestContent#scriptPrefix#.txt" variable="modelTestContent">
...
<ide>  
	...
	<dialog width="550" height="350" title="ColdBox Model Test Wizard" image="includes/images/ContentBox_43.png"/>  
	<body>
	<![CDATA[
	<html>
		<head>
