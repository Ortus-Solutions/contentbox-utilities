...
templatesLocation 	= expandPath('/contentboxExtesion/templates/ses') & "/";
...
<ide>
	...
	<dialog width="650" height="450" title="ColdBox URL Rewrite Rules Created" image="includes/images/ContentBox_43.png"/>
	<body><![CDATA[
	<html>
		<head>
