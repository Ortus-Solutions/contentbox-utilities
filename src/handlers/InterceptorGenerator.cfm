...
<!--- Read in Template --->
<cffile action="read" file="#ExpandPath('/contentboxExtesion')#/templates/InterceptorContent#scriptPrefix#.txt" variable="interceptorContent">
<cffile action="read" file="#ExpandPath('/contentboxExtesion')#/templates/InterceptorMethod#scriptPrefix#.txt" variable="interceptorMethod">
