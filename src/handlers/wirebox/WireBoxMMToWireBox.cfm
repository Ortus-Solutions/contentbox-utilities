...
converter 		= createObject("component","contentboxExtesion.model.util.MMToWireBox").init();
// start conversion
...
<ide> 
	...
	<dialog width="600" height="250" title="WireBox Model Mapping Converter" image="includes/images/ContentBox_43.png"/>  
	<body> 
	<![CDATA[ 
	<html>
		<head>
