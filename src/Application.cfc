...
<cfcomponent output="false">
	...
	<cfscript>
		this.name				= "ContentBoxCFBuilderExtension_#hash(getCurrentTemplatePath())#";
		this.sessionManagement	= true;
		
		// Local Mappings for Extension
		this.mappings["/contentboxExtesion"] = getDirectoryFromPath( getCurrentTemplatePath() );
	</cfscript>
    ...
    <cffunction name="getExtensionController" output="false" access="private" returntype="any" hint="Get the extension controller">
    	<cfargument name="data">
    		<cfreturn createObject("component","contentboxExtesion.model.ExtensionController").init( arguments.data )>
    </cffunction>
